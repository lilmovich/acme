...
/**
 * Class m191208_084152_create_table_country
 */
class m191208_084152_create_table_country extends Migration
{
    /**
     * {@inheritdoc}
     */
...
$this->batchInsert('country', ['id', 'code', 'name', 'phonecode', 'lat', 'lng'], [
    ...
    {
        echo "m191208_084152_create_table_country cannot be reverted.\n";
